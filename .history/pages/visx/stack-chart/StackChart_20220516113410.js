...
const data = [
    ...
    { temp1: 40, temp2: 20, date: '2020-01-09' },
...
export default function StackChart({
    ...
    const handleTooltip = (event) => {
        ...
        console.log('Temp Val', getTempValue1(d0), getTempValue2(d0));
    ...
    return width < 10 ? null : (
        <svg width={width} height={height}>
            ...
            {tooltipData && (
                <g>
                    <Line
                        from={{ x: tooltipLeft[0], y: margin.top * 2 }}
                        to={{ x: tooltipLeft[0], y: innerHeight + margin.top }}
                        stroke={'black'}
                        strokeWidth={2}
                        pointerEvents="none"
                        strokeDasharray="5,2"
