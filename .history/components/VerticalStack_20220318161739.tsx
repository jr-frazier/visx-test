...
const temperatureTotals: Array<number> = data.reduce((allTotals: Array<number> , currentDate: CurrentDate) => {
  const totalTemperature: number = keys.reduce((dailyTotal: number, k: string) => {
...
let tooltipTimeout: number | NodeJS.Timeout;
